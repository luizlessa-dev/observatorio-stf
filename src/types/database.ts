    ...
    Tables: {
      ...
      stf_decisoes_covid: {
        Row: {
          ...
          id_processo_fonte: number | null;
          fonte:             string;
          created_at:        string;
        };
        Insert: Omit<Database["public"]["Tables"]["stf_decisoes_covid"]["Row"], "id" | "created_at" | "fonte"> & { fonte?: string };
        Update: Partial<Database["public"]["Tables"]["stf_decisoes_covid"]["Insert"]>;
        Relationships: [];
      };
      stf_distribuicao: {
        Row: {
      ...
      stf_recebimento_baixa: {
        ...
        Insert: Omit<Database["public"]["Tables"]["stf_recebimento_baixa"]["Row"], "id" | "processo" | "created_at" | "fonte"> & { fonte?: string };
        Update: Partial<Database["public"]["Tables"]["stf_recebimento_baixa"]["Insert"]>;
        Relationships: [];
      };
      stf_acervo: {
        Row: {
